...
public class ChallengeRewardOverlay {
    ...
    /** Identifier the overlay is registered under in the 26.2 HUD element list. */
    private static final Identifier HUD_ELEMENT_ID =
            Identifier.fromNamespaceAndPath(ChallengeCraft.MOD_ID, "challenge_reward_overlay");

    public static void register() {
        // 26.2 removed HudRenderCallback; the HUD is an ordered element list now. addLast keeps the
        // old behaviour of drawing after (on top of) everything vanilla renders.
