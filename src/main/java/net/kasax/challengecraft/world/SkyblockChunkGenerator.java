...
public class SkyblockChunkGenerator extends ChunkGenerator {
    ...
    public void buildSurface(
        ...
        worldAccess.setBlock(new BlockPos(0, 64, 0), Blocks.GRASS_BLOCK.defaultBlockState(), 2);
        worldAccess.setBlock(new BlockPos(0, 63, 0), Blocks.DIRT.defaultBlockState(), 2);
