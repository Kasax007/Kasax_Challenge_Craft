...
public class LockoutBingoSavedData extends SavedData {
    ...
    private static final net.minecraft.resources.Identifier KEY = net.minecraft.resources.Identifier
            .fromNamespaceAndPath(net.kasax.challengecraft.ChallengeCraft.MOD_ID, "challengecraft_lockout_bingo");
    ...
    public static final SavedDataType<LockoutBingoSavedData> TYPE =
            new SavedDataType<>(KEY, LockoutBingoSavedData::new, CODEC, DataFixTypes.LEVEL);
